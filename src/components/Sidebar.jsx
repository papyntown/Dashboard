...
const Sidebar = () => {
    ...
    const handleCloseSideBar = () => {
        console.log(screenSize, "T'a clicker");
    ...
    const normalLink =
        "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg  text-md text-gray-700 dark:text-gray-400 m-2 dark:hover:text-black hover:bg-light-gray m-2";
    return (
